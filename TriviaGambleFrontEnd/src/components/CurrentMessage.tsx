...
export default function CurrentMessage({ gamePhase, gameData, currentRound, localPlayer, toggleMessage }) {
    ...
    const numberOfCurrentRound = gameData.rounds.length
    const [numberOfLastRound, setNumberOfLastRound] = useState(0)
    ...
    const [lastHighBet, setLastHighBet] = useState(0)

    // Below is game flow for messages
